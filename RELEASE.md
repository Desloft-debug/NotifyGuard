...
1. Завести аккаунт на codeberg.org и открыть issue:
   https://codeberg.org/IzzyOnDroid/repodata/issues
   (трекер переехал с GitLab, старый адрес больше не принимает заявки)
...
Further notices: the source code was written with the help of a generative AI
assistant, under my direction and testing. Disclosing this because of your
AI policy — please tell me if that rules the app out.
